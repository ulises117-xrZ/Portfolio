...
const validarCampo = (exp,inp, campo)=>{
...
formulario.addEventListener('submit', e=>{
	...
	if (campos.nombre && campos.correo ){
		formulario.reset();
		let exito = document.getElementById('formulario__mensaje-exito');
		...
		document.querySelectorAll('.formulario__grupo-correcto').forEach((icno)=>{
			icno.classList.remove('formulario__grupo-correcto')
		})
	} else {
